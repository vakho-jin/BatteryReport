...
class BatteryApp:
    ...
    def build_ui(self):
        ...
        tk.Label(tf, text="ელემენტის ჯანმრთელობის ანალიზი", font=("Segoe UI", 9),
    ...
    def save_result(self):
        ...
        lines = [
            ...
            "========================================",
            f"  Battery Health Monitor v{APP_VERSION}",
    ...
    def show_about(self):
        ...
        win.grab_set()
        tk.Label(win, text="⚡ Battery Health Monitor", font=("Segoe UI", 14, "bold"),
    ...
    def show_author(self):
        ...
        win.resizable(False, False)
        win.grab_set()
        tk.Label(win, text="👤 Об авторе", font=("Segoe UI", 14, "bold"),
                 bg="#0f172a", fg="#f1f5f9").pack(pady=(24, 4))
        ...
        for label, value in [
            ...
            ("ქალაქი",  "ქუთაისი"),
            ("ქვეყანა", "საქართველო 🇬🇪"),
            ("პროფესია",   "Backend Developer & System Administrator"),
        ]:
            row = tk.Frame(info_frame, bg="#0f172a")
            row.pack(anchor="w", pady=2)
            tk.Label(row, text=f"{label}:", font=("Segoe UI", 9),
                     bg="#0f172a", fg="#475569", width=10, anchor="w").pack(side="left")
            tk.Label(row, text=value, font=("Segoe UI", 9, "bold"),
                     bg="#0f172a", fg="#e2e8f0").pack(side="left")
        tk.Button(win, text="დახურვა", font=("Segoe UI", 9, "bold"),
                  bg="#334155", fg="white", relief="flat", padx=16, pady=6,
